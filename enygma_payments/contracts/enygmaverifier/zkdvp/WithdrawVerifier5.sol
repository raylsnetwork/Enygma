...
contract Verifier {
    ...
    uint256 constant ALPHA_X =
        9544601866165970719241926017576223845401323886438319951514855732040672246518;
    uint256 constant ALPHA_Y =
        21222186459196978484580765080488162151591746374543190215634232317626954701849;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        16979288136479486851613745673085631581572897749864683679494040117170611839137;
    uint256 constant BETA_NEG_X_1 =
        6662901999599567801698168286569892275024655794824394852537901553822113934949;
    uint256 constant BETA_NEG_Y_0 =
        10397646463052995914066314979416120415421550602878765270138611153866255608259;
    uint256 constant BETA_NEG_Y_1 =
        21734269451812983389850770611047921339671180152653091072882413396462062649584;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        17091934169624869440985910394923844238407386576852883837149503088716218091139;
    uint256 constant GAMMA_NEG_X_1 =
        17612180174701372180331243075261071722717851279078725853816786970965443405101;
    uint256 constant GAMMA_NEG_Y_0 =
        7381202533268096641063809397047477720989059357004179386522294345948971490003;
    uint256 constant GAMMA_NEG_Y_1 =
        19238016442290795894434322055776809773021305595814425454780445985495748978545;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        7958237890679426020350142304890613148659360831502955528988442034137370580582;
    uint256 constant DELTA_NEG_X_1 =
        1040219168074766884983827962961433421718234843058826114025749274992723058681;
    uint256 constant DELTA_NEG_Y_0 =
        7728682770569862547040779207562754601794063751737140547145434864137559866055;
    uint256 constant DELTA_NEG_Y_1 =
        11708584529738425167248910079425420799825161264106254892044252861709152953241;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        2049132822036779601333422034711561822294939024892064918490949053560157308200;
    uint256 constant CONSTANT_Y =
        6865708651851551089971289504933169530474318499833707733851654666669460816493;
    uint256 constant PUB_0_X =
        2213241476402696979155960693710409018019489481055973990000080196866455541650;
    uint256 constant PUB_0_Y =
        16431806616011488913939363883018508910794460063137301773398307568882559987634;
