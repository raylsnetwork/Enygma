...
// AddFeeVerifier is a paid mutator transaction binding the contract method.
//
...
// TransferWithFee is a paid mutator transaction binding the contract method.
//
...
// ViewKeys is a free data retrieval call binding the contract method.
//
// Solidity: function viewKeys(uint256 accountId) view returns(bytes)
func (_Enygma *EnygmaCaller) ViewKeys(opts *bind.CallOpts, accountId *big.Int) ([]byte, error) {
        var out []interface{}
        err := _Enygma.contract.Call(opts, &out, "viewKeys", accountId)
        if err != nil {
                return nil, err
        }
...
//
// Solidity: function viewKeys(uint256 accountId) view returns(bytes)
func (_Enygma *EnygmaSession) ViewKeys(accountId *big.Int) ([]byte, error) {
        return _Enygma.Contract.ViewKeys(&_Enygma.CallOpts, accountId)
}

// ViewKeys is a free data retrieval call binding the contract method.
//
// Solidity: function viewKeys(uint256 accountId) view returns(bytes)
func (_Enygma *EnygmaCallerSession) ViewKeys(accountId *big.Int) ([]byte, error) {
        return _Enygma.Contract.ViewKeys(&_Enygma.CallOpts, accountId)
}
