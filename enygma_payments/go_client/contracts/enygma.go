...
//
// Solidity: function getPublicValues(uint256 size) view returns((uint256,uint256)[], uint256[])
func (_Enygma *EnygmaCaller) GetPublicValues(opts *bind.CallOpts, size *big.Int) ([]IEnygmaPoint, []*big.Int, error) {
        var out []interface{}
        err := _Enygma.contract.Call(opts, &out, "getPublicValues", size)

        if err != nil {
                return *new([]IEnygmaPoint), *new([]*big.Int), err
        }
...
//
// Solidity: function getPublicValues(uint256 size) view returns((uint256,uint256)[], uint256[])
func (_Enygma *EnygmaSession) GetPublicValues(size *big.Int) ([]IEnygmaPoint, []*big.Int, error) {
...
//
// Solidity: function getPublicValues(uint256 size) view returns((uint256,uint256)[], uint256[])
func (_Enygma *EnygmaCallerSession) GetPublicValues(size *big.Int) ([]IEnygmaPoint, []*big.Int, error) {
        return _Enygma.Contract.GetPublicValues(&_Enygma.CallOpts, size)
}
...
//
// Solidity: function pubKeys(uint256 ) view returns(uint256)
func (_Enygma *EnygmaCaller) PubKeys(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
        var out []interface{}
...
//
// Solidity: function pubKeys(uint256 ) view returns(uint256)
func (_Enygma *EnygmaSession) PubKeys(arg0 *big.Int) (*big.Int, error) {
...
//
// Solidity: function pubKeys(uint256 ) view returns(uint256)
func (_Enygma *EnygmaCallerSession) PubKeys(arg0 *big.Int) (*big.Int, error) {
        return _Enygma.Contract.PubKeys(&_Enygma.CallOpts, arg0)
}
...
//
// Solidity: function registerAccount(address addr, uint256 accountNum, uint256 kValue, uint256 r) returns(bool)
func (_Enygma *EnygmaTransactor) RegisterAccount(opts *bind.TransactOpts, addr common.Address, accountNum *big.Int, kValue *big.Int, r *big.Int) (*types.Transaction, error) {
        return _Enygma.contract.Transact(opts, "registerAccount", addr, accountNum, kValue, r)
}

// RegisterAccount is a paid mutator transaction binding the contract method 0x94e5f1c6.
//
// Solidity: function registerAccount(address addr, uint256 accountNum, uint256 kValue, uint256 r) returns(bool)
func (_Enygma *EnygmaSession) RegisterAccount(addr common.Address, accountNum *big.Int, kValue *big.Int, r *big.Int) (*types.Transaction, error) {
        return _Enygma.Contract.RegisterAccount(&_Enygma.TransactOpts, addr, accountNum, kValue, r)
}

// RegisterAccount is a paid mutator transaction binding the contract method 0x94e5f1c6.
//
// Solidity: function registerAccount(address addr, uint256 accountNum, uint256 kValue, uint256 r) returns(bool)
func (_Enygma *EnygmaTransactorSession) RegisterAccount(addr common.Address, accountNum *big.Int, kValue *big.Int, r *big.Int) (*types.Transaction, error) {
        return _Enygma.Contract.RegisterAccount(&_Enygma.TransactOpts, addr, accountNum, kValue, r)
}

// Transfer is a paid mutator transaction binding the contract method 0x9a7d5fc0.
//
// Solidity: function transfer((uint256,uint256)[] commitments, (uint256[8],uint256[62]) proof, uint256[] kIndex) returns(bool)
