...
//
// Identical to PaymentRequest with one addition: StFee (the protocol fee the
// sender absorbs). The conservation law inside the circuit becomes:
//
...
// PaymentFeeOutput is the JSON response from the /proof/paymentFee endpoint.
